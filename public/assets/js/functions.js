...
// Add throttling utility function
...
// Add debouncing utility function
...
var e = {
    ...
    stickyHeader: function () {
        ...
        if (e.isVariableDefined(stickyNav)) {
            ...
            if (e.isVariableDefined(stickySpace)) {
                // Use throttled scroll listener with passive option
                var handleStickyScroll = throttle(function () {
                ...
                document.addEventListener('scroll', handleStickyScroll, { passive: true });
            }
        }
    },
    // END: Sticky Header
    ...
    backTotop: function () {
        ...
        if (e.isVariableDefined(backBtn)) {
            ...
            var handleBackToTopScroll = throttle(function () {
                ...
                if (scrollpos >= 800) {
                    if (!backBtn.classList.contains('back-top-show')) {
                        add_class_on_scroll();
                    }
                } else {
                    if (backBtn.classList.contains('back-top-show')) {
    ...
    if (e.isVariableDefined(sp)) {
        ...
        // Use throttled scroll listener with passive option
        var handleStickyElementScroll = throttle(function () {
            scrollpos = window.scrollY;
            if (scrollpos >= 800) {
                if (!sp.classList.contains('sticky-element-sticked')) {
                    add_class_on_scroll();
                }
            } else {
                if (sp.classList.contains('sticky-element-sticked')) {
        ...
        window.addEventListener('scroll', handleStickyElementScroll, { passive: true });
    }
    },
    // END: Sticky element
