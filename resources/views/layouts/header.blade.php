        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="top-utility-left">
                <span class="text-muted small">
                    <i class="bi bi-telephone me-1"></i>+381621803794
                </span>
                <span class="text-muted small ms-3">
                                            <i class="bi bi-envelope me-1"></i>info@fastbuss.com
                </span>
            </div>
            <div class="top-utility-right">
                ...
                <div class="dropdown d-inline-block me-3">
                    ...
                    <ul class="dropdown-menu modern-dropdown-menu" aria-labelledby="topCurrencyDropdown">
                        ...
                        <li><a class="dropdown-item d-flex justify-content-between align-items-center currency-option" href="#" data-value="RSD" data-symbol="дин"><span>RSD</span><span>дин</span></a></li>
				</ul>
			</div>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				<ul class="navbar-nav mx-auto modern-nav">
					...
					<li class="nav-item">
						<a class="nav-link modern-nav-link" href="{{ route('about.index') }}">
							About Us
						</a>
					</li>
					<!-- <li class="nav-item">
								...
								<div class="notification-list">
									<a href="#" class="dropdown-item notification-item">
										<div class="d-flex">
											...
											<div class="notification-content">
												<h6 class="mb-1">New Route Available!</h6>
												<p class="mb-1 small text-muted">Lusaka to Livingstone route now available with daily departures</p>
									...
									<a href="#" class="dropdown-item notification-item">
										<div class="d-flex">
											...
											<div class="notification-content">
												<h6 class="mb-1">Your bus departs in 30 minutes</h6>
												<p class="mb-1 small text-muted">Bus #LT-2024 to Kitwe - Gate 3, Platform 2</p>
									...
									<a href="#" class="dropdown-item notification-item">
										<div class="d-flex">
											...
											<div class="notification-content">
												<h6 class="mb-1">Weekend Special Offer</h6>
												<p class="mb-1 small text-muted">Get 20% off on all weekend bus tickets to Copperbelt</p>
									...
									<a href="#" class="dropdown-item notification-item">
										<div class="d-flex">
											...
											<div class="notification-content">
												<h6 class="mb-1">Enhanced Safety Measures</h6>
												<p class="mb-1 small text-muted">All buses now equipped with GPS tracking and safety protocols</p>
									...
									<a href="#" class="dropdown-item notification-item">
										<div class="d-flex">
											...
											<div class="notification-content">
												<h6 class="mb-1">Rate your recent trip</h6>
												<p class="mb-1 small text-muted">How was your journey from Lusaka to Ndola?</p>
  ...
  <div class="mobile-header-actions">
    ...
    @auth
      <a href="#" title="Notifications" id="mobileNotifBell" style="position:relative;">
        <i class="bi bi-bell"></i>
        <span class="notification-badge" style="position:absolute;top:0;right:-2px;background:#d00;color:#fff;font-size:0.7rem;padding:2px 5px;border-radius:10px;line-height:1;">3</span>
      </a>
    ...
    <div class="mobile-dropdown-item">
      ...
      <div class="collapse" id="mobileCurrencyDropdown">
        <div class="mobile-dropdown-content">
          ...
          <a href="#" class="mobile-dropdown-option currency-option" data-value="CHF" data-symbol="CHF">
            <span>CHF</span>
            <span>CHF</span>
          </a>
          <a href="#" class="mobile-dropdown-option currency-option" data-value="RSD" data-symbol="дин">
            <span>RSD</span>
            <span>дин</span>
          </a>
        </div>
