            ...
            <div class="top-utility-right">
                ...
                <div class="dropdown d-inline-block me-3">
                    ...
                    <ul class="dropdown-menu modern-dropdown-menu" aria-labelledby="topCurrencyDropdown">
                        ...
                        <li><a class="dropdown-item d-flex justify-content-between align-items-center currency-option" href="#" data-value="PKR" data-symbol="Rs"><span>PKR</span><span>Rs</span></a></li>
	...
	<nav class="navbar navbar-expand-xl">
		<div class="container">
			...
			<a class="navbar-brand modern-brand" href="/">
				...
				<img class="dark-mode-item navbar-brand-item" src="{{ asset('assets/images/logo.jpeg') }}" alt="FastBuss Market">
			</a>
    ...
    <div class="mobile-dropdown-item">
      ...
      <div class="collapse" id="mobileCurrencyDropdown">
        <div class="mobile-dropdown-content">
          ...
          <a href="#" class="mobile-dropdown-option currency-option" data-value="PKR" data-symbol="Rs">
            <span>PKR</span>
            <span>Rs</span>
          </a>
