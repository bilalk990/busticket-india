<footer class="footer-modern bg-gradient-dark text-white">
    <!-- Main Footer Content -->
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-brand mb-4">
                    <a href="{{ route('home') }}" class="d-inline-block mb-4">
                        <img class="h-60px" src="{{ asset('assets/images/logo.jpeg') }}" alt="FastBuss Logo">
                    </a>
                    <p class="text-light-emphasis mb-4 fs-6 lh-relaxed">
                        Your trusted platform for seamless bus ticket booking and travel solutions. 
                        Experience convenience, reliability, and comfort with every journey.
                    </p>
                    <div class="social-links">
                        <h6 class="text-white mb-3 fw-semibold d-flex align-items-center">
                            <i class="fas fa-share-alt me-2 text-primary"></i>
                            Connect With Us
                        </h6>
                        <div class="d-flex gap-3">
                            <a href="#" class="social-link facebook" target="_blank" aria-label="Facebook">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a href="#" class="social-link twitter" target="_blank" aria-label="Twitter">
                                <i class="fab fa-twitter"></i>
                            </a>
                            <a href="#" class="social-link instagram" target="_blank" aria-label="Instagram">
                                <i class="fab fa-instagram"></i>
                            </a>
                            <a href="#" class="social-link linkedin" target="_blank" aria-label="LinkedIn">
            ...
            <div class="col-lg-2 col-md-6">
                <div class="footer-section">
                    <h6 class="text-white mb-4 fw-semibold position-relative d-flex align-items-center">
                    ...
                    <ul class="footer-links list-unstyled">
                        <li class="mb-3">
                            <a href="{{ route('about.index') }}" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                About Us
                            </a>
                        </li>
                        <li class="mb-3">
                            <a href="{{ route('contact.index') }}" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                Contact Us
                            </a>
                        </li>
                        <li class="mb-3">
                            <a href="partners" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                Become a Partner
                            </a>
                        </li>
                        <li class="mb-3">
                            <a href="{{ route('careers') }}" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                Careers
                            </a>
                        </li>
            ...
            <div class="col-lg-2 col-md-6">
                <div class="footer-section">
                    ...
                    <ul class="footer-links list-unstyled">
                        <li class="mb-3">
                            <a href="/" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                Bus Tickets
                            </a>
                        </li>
                        <!-- <li class="mb-3">
                            <a href="{{ route('ticket-resales.index') }}" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                Ticket Resale
                            </a>
                        </li>
                        <li class="mb-3">
                            <a href="{{ route('ticket-resales.my-listings') }}" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                My Listings
                            </a>
                        </li>
                        <li class="mb-3">
                            <a href="{{ route('ticket-resales.my-bids') }}" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                My Bids
                            </a>
                        </li> -->
            ...
            <div class="col-lg-2 col-md-6">
                <div class="footer-section">
                    ...
                    <ul class="footer-links list-unstyled">
                        <li class="mb-3">
                            <a href="{{ route('help-center') }}" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                Help Center
                            </a>
                        </li>
                        <li class="mb-3">
                            <a href="{{ route('faqs') }}" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                FAQs
                            </a>
                        </li>
                        <li class="mb-3">
                            <a href="{{ route('ticket-policies') }}" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                Ticket Policies
                            </a>
                        </li>
                        <li class="mb-3">
                            <a href="{{ route('refund-policy') }}" class="footer-link text-light-emphasis text-decoration-none d-flex align-items-center">
                                <span class="link-bullet me-2"></span>
                                Refund Policy
                            </a>
                        </li>
                ...
                <div class="footer-section">
                    ...
                    <div class="contact-info">
                        <div class="contact-item mb-4">
                            <a href="https://wa.me/381621803794" class="contact-link text-light-emphasis text-decoration-none d-flex align-items-start" target="_blank">
                                <div class="contact-icon whatsapp me-3 flex-shrink-0">
                                    <i class="fab fa-whatsapp"></i>
                                </div>
                                <div>
                                    <div class="fw-semibold text-white mb-1">WhatsApp</div>
                                    <div class="small">+381621803794</div>
                                </div>
                            </a>
                        </div>
                        <div class="contact-item mb-4">
                            <a href="mailto:info@fastbuss.com" class="contact-link text-light-emphasis text-decoration-none d-flex align-items-start">
                                <div class="contact-icon email me-3 flex-shrink-0">
                                    <i class="fas fa-envelope"></i>
                                </div>
                                <div>
                                    <div class="fw-semibold text-white mb-1">Email</div>
                                    <div class="small">info@fastbuss.com</div>
                                </div>
                            </a>
                        </div>
                        <div class="contact-item">
                            <div class="contact-link text-light-emphasis text-decoration-none d-flex align-items-start">
                                <div class="contact-icon location me-3 flex-shrink-0">
                                    <i class="fas fa-map-marker-alt"></i>
                                </div>
                                <div>
                                    <div class="fw-semibold text-white mb-1">Address</div>
                                    <div class="small">veliki Trnovac 001 A Bujanovac Serbia</div>
                                </div>
                            </div>
                        </div>
                    </div>
