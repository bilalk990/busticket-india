            ...
            <div class="col-md-10">
                ...
                <div class="p-3 bus-listing d-flex flex-md-row flex-column align-items-center justify-content-between">
                    <div class="text-center col-md-6 text-md-start">
                        <img class="h-40px rounded-2"
                            src="@agencyLogo($busRoute->agency->agency_logo)"
                            alt="{{ $busRoute->agency->agency_name }}"
                            onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name={{ urlencode($busRoute->agency->agency_name) }}&background=f1f5f9&color=1e293b&size=128&bold=true';">
