...
<section class="pt-0">
	<div class="">
        <div class="p-4 p-sm-5" style="background-image: url({{ asset('assets/images/1.png') }}); background-repeat: no-repeat; background-size: cover;">
            <div class="pt-0 pb-5 row justify-content-between">
                <div class="pb-5 mb-0 col-md-7 col-lg-8 col-xxl-7 mb-lg-5">
                    ...
                    <h4 class="text-white text-sub">{{ __('lang.access_flights') }}</h4>
                </div>
            </div>
        </div>
		...
		<div class="row mt-n7">
			<div class="mx-auto col-11">
                <form action="{{ route('flights.search') }}" method="POST" class="p-4 shadow bg-mode rounded-3">
                @csrf
                <div class="row g-4 align-items-center">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-3">
                                <div class="mt-2 form-border-bottom form-control-transparent form-fs-lg">
                                    <input type="text" name="origin_display" id="from" class="form-control form-input" placeholder="{{ __('lang.from_placeholder') }}" autocomplete="off" required>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="mt-2 form-border-bottom form-control-transparent form-fs-lg">
                                    <input type="text" name="destination_display" id="to" class="form-control form-input" placeholder="{{ __('lang.to_placeholder') }}" autocomplete="off" required>
                            ...
                            <div class="col-md-6 col-lg-2">
                                <div class="mt-2 form-border-bottom form-control-transparent form-fs-lg">
                                    <input name="departure_date_display" id="departureDateDisplay" type="text" class="py-2 form-control form-input" placeholder="{{ __('lang.choose_date') }}" required readonly>
                                    <input name="departure_date" id="departureDate" type="hidden">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-2">
                                <div class="mt-2 form-border-bottom form-control-transparent form-fs-lg">
                                    <input name="return_date_display" id="returnDateDisplay" type="text" class="py-2 form-control form-input" placeholder="{{ __('lang.add_return') }}" readonly>
                                    ...
                                    <div class="dropdown guest-selector me-2">
                                        ...
                                        <ul class="dropdown-menu guest-selector-dropdown">
                                            <li class="d-flex justify-content-between">
                                                ...
                                                <button type="button" class="p-0 mb-0 btn btn-link adult-remove">
                                                    <i class="bi bi-dash-circle fs-5 fa-fw"></i>
                                                </button>
                                                <h6 class="mb-0 guest-selector-count adults" id="adults-count">1</h6>
                                                <button type="button" class="p-0 mb-0 btn btn-link adult-add">
                                            ...
                                            <li class="d-flex justify-content-between">
                                                ...
                                                <div class="gap-1 hstack align-items-center">
                                                    ...
                                                    <h6 class="mb-0 guest-selector-count children" id="children-count">0</h6>
                                            ...
                                            <div class="gap-1 flex-fill hstack align-items-center">
                                                <select id="cabin-class" class="form-select uniform-select" name="cabin_class">
                    ...
                    <div class="col-xl-2">
                        <div class="d-grid">
                            <button class="mb-0 btn btn-lg btn-dark" type="submit" name="submit">{{ __('lang.search') }}</button>
                        </div>
                    </div>
                </div>
                </form>
    ...
    <div class="container">
        <div class="row g-4 g-lg-5 justify-content-center">
            <div class="text-center col-sm-6 col-md-4 position-relative">
                <!-- SVG decoration -->
                <figure class="top-0 mt-8 position-absolute start-100 translate-middle d-none d-lg-block">
                ...
                <div class="px-4">
                    ...
                    <h5>{{ __('lang.search_choice') }}</h5>
                    <p class="mb-0">{{ __('lang.destinations_we_work_with') }}</p>
                </div>
            </div>
            <div class="pt-0 text-center col-sm-6 col-md-4 position-relative pt-lg-5">
        ...
        <div class="p-4 bg-light rounded-3 position-relative p-sm-5">
            ...
            <div class="row align-items-center position-relative">
                ...
                <div class="col-lg-4 text-lg-end">
                    <a href="" class="mb-0 btn btn-lg btn-dark">Book a Flight</a>
                </div>
            </div>
        </div>
    </div>
