                        ...
                        <div class="booking-card">
                            <div class="booking-card-details">
                                <div class="booking-card-header">
                                    <div class="d-flex align-items-center">
                                        @php
                                        $logoUrl = agency_logo_url($booking->schedule->bus->agency->agency_logo ?? '');
                                        @endphp
                                        @if ($logoUrl)
                                            <img class="booking-card-logo" src="{{ $logoUrl }}" alt="{{ $booking->schedule->bus->agency->agency_name }}">
                                        @else
                                            <div class="booking-card-logo d-flex align-items-center justify-content-center bg-light rounded"><i class="fas fa-bus text-muted"></i></div>
                                        @endif
                                        <div>
                                            ...
                                            @forelse($availableSchedules as $schedule)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            @php
                                                                $schedLogoUrl = agency_logo_url($schedule['bus']->agency->agency_logo ?? '');
                                                            @endphp
                                                            @if ($schedLogoUrl)
                                                                <img class="booking-card-logo me-2" src="{{ $schedLogoUrl }}" alt="{{ $schedule['bus']->agency->agency_name }}">
                                                            @else
                                                                <div class="booking-card-logo me-2 d-flex align-items-center justify-content-center bg-light rounded"><i class="fas fa-bus text-muted"></i></div>
                                                            @endif
