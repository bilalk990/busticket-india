                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    @php
                                                        $logoUrl = agency_logo_url($resale->booking->schedule->bus->agency->agency_logo ?? '');
                                                    @endphp
                                                    @if ($logoUrl)
                                                        <img class="agency-logo" src="{{ $logoUrl }}" alt="{{ $resale->booking->schedule->bus->agency->agency_name }}">
                                                    @else
                                                        <div class="agency-logo d-flex align-items-center justify-content-center bg-light rounded"><i class="fas fa-bus text-muted" style="font-size:0.8rem;"></i></div>
                                                    @endif
                                                    <div class="ms-3">
                                    ...
                                    @if($userBids->count() > 0)
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    @php
                                                        $logoUrl = agency_logo_url($bid->ticketResale->booking->schedule->bus->agency->agency_logo ?? '');
                                                    @endphp
                                                    @if ($logoUrl)
                                                        <img class="agency-logo" src="{{ $logoUrl }}" alt="{{ $bid->ticketResale->booking->schedule->bus->agency->agency_name }}">
                                                    @else
                                                        <div class="agency-logo d-flex align-items-center justify-content-center bg-light rounded"><i class="fas fa-bus text-muted" style="font-size:0.8rem;"></i></div>
                                                    @endif
                                                    <div class="ms-3">
