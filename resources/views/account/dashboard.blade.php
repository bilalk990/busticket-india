                ...
                <div class="col-lg-8 col-xl-9 ps-xl-5">
                    ...
                    <div class="dashboard-cards">
                        <div class="dashboard-card">
                            ...
                            <div class="card-value">{{ $totalBookings ?? 0 }}</div>
                            <div class="card-meta">
                                <i class="fas fa-ticket-alt"></i>
                                <span>All time</span>
                            </div>
                        ...
                        <div class="dashboard-card">
                            ...
                            <div class="card-value">{{ $upcomingTrips ?? 0 }}</div>
                            <div class="card-meta">
                        ...
                        <div class="dashboard-card">
                            ...
                            <div class="card-value">{{ $completedTrips ?? 0 }}</div>
                            <div class="card-meta">
                        ...
                        <div class="dashboard-card">
                            ...
                            <div class="card-value">{{ $canceledTrips ?? 0 }}</div>
                            <div class="card-meta">
                                <i class="fas fa-times-circle"></i>
                        ...
                        @if($upcomingBookings->count() > 0)
                            @foreach($upcomingBookings as $booking)
                                <div class="trip-card">
                                    ...
                                    <div class="trip-info">
                                        <div class="trip-route">{{ $booking->pickup ?? 'N/A' }} → {{ $booking->dropoff ?? 'N/A' }}</div>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="d-flex align-items-center mt-1">
                                                        @php
                                                            $logoUrl = agency_logo_url($booking->agency_logo ?? '');
                                                        @endphp
                                                        @if ($logoUrl)
                                                            <img class="agency-logo" src="{{ $logoUrl }}" alt="{{ $booking->agency_name }}">
                                                        @else
