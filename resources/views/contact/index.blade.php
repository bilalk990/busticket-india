...
<main class="main-top">
    <!-- Visual Hero Section -->
    <section class="modern-glass-hero text-center text-white">
        <div class="container animate__animated animate__fadeIn">
            <h1 class="display-3 fw-bold mb-3">Get in Touch</h1>
            <p class="lead mb-4 opacity-75">We'd love to hear from you. Our team is here to help with any questions or feedback.</p>
            <div class="d-flex justify-content-center gap-3">
                <a href="#contact-form" class="btn btn-lg btn-primary px-4 shadow-sm">
                    <i class="bi bi-envelope-fill me-2"></i>Send Message
                </a>
                <a href="tel:+381621803794" class="btn btn-lg btn-outline-light px-4">
